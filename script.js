...
function ans1() {
  ...
  answer.textContent =
    "Step back and observe the situation for a few minutes. Wait to see if a parent arrives. If the animal is in immediate danger of a predator or is in the road, remove the baby and bring to a rescue center.";
}
...
function ans4() {
  ...
  answer.textContent =
    "We needvolunteers to help feed animals, care for animals, and clean animal pins. We also accept donations. ";
}
